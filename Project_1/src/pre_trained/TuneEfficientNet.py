...
logging.basicConfig(filename='runs/efficientnet_b0/02_efficientnet_seed_vflip_3.log', filemode='a', level=logging.INFO,
...
config = {
    ...
    'save_name': '02_efficientnet_best_seed_vflip_3.pth'
}
...
def main():
    ...
    data_helper = DataHelper(resize=config["resize"], batch_size=config["batch_size"], augmentations=config["augmentations"],
                             subset_fraction=config["subset_percentage"])
